          ...
          <div class="js-sidebar-scroll">
            ...
            <div class="content-side content-side-user px-0 py-0">
              ...
              <div class="smini-visible-block animated fadeIn px-3">
                <img class="img-avatar img-avatar32" src="assets/images/logo1.jpg" alt="">
              </div>
              ...
              <div class="smini-hidden text-center mx-auto">
                <a class="img-link" href="be_pages_generic_profile.php">
                  <img class="img-avatar" src="assets/images/logo1.jpg" alt="">
                </a>
            ...
            <div class="content-side content-side-full">
              <ul class="nav-main">
                ...
                <li class="nav-main-item">
                  <a class="nav-main-link active" href="be_pages_okulkurallari.php">
      ...
      <main id="main-container">
        ...
        <div class="content">
          <section id="vyne-kurallar">
            <h4 class="vynkural">VYNE College Okul Kuralları</h4>
            <div class="rules-container">
              <?php
              for ($i = 1; $i <= 11; $i++) {
                  echo '<img src="assets/images/okulkurallar/okul' . $i . '.png" alt="Kurallar Sayfa ' . $i . '" loading="lazy">';
              }
              ?>
            </div>
          </section>
